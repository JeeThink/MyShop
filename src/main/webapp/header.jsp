...
<div class="container-fluid">
    <div class="col-lg-4 col-md-4 col-sm-3">
        ...
        <a style="color: black; font-size: 25px"
           href="${pageContext.request.contextPath }/product?method=index">欣欣综合商城</a>
    </div>
    <div class="col-lg-4 col-md-5 col-sm-5">
        <img src="img/header.png"/>
    </div>
    <div class="col-lg-4 col-md-3 col-sm-4" style="padding-top: 20px">
        <ol class="list-inline">
            ...
            <c:if test="${!empty user }">
                ...
                <li><a
                        href="${pageContext.request.contextPath }/product?method=myOrders">我的订单</a></li>
            </c:if>
